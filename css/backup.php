<div class="qodef-content--left-side qodef-content-side">
		...
		<li class="menu-item menu-item-type-custom menu-item-object-custom qodef-menu-item--narrow"><a href="#"><span class="qodef-menu-item-inner">Blogs</span></a><span class="qodef-menu-arrow"></span>
              </li>

			  <!-- recolor navagation bar -->
<style>
    .text-color
    {
        color: #fff;
...
<body class="home page-template page-template-page-full-width page-template-page-full-width-php page page-id-15 theme-banquet qode-framework-1.1.3 woocommerce-no-js qodef-back-to-top--enabled qodef-content-grid-1300 qodef-content-behind-header qodef--page-has-borders qodef-header--dar qodef-header--standard qodef-header-appearance--none qodef-mobile-header--standard qodef-drop-down-second--full-width banquet-core-1.1 banquet-1.1 wpb-js-composer js-comp-ver-6.3.0 vc_responsive qodef-header-standard--center qodef-search--fullscreen" itemscope itemtype="https://schema.org/WebPage">
    ...
    <header id="qodef-page-header">
      <div id="qodef-page-header-inner">
        <a itemprop="url" class="qodef-header-logo-link qodef-height--not-set" href="../index.html" rel="home">
          ...
          <img width="202" height="60" src="img/logo.png" class="qodef-header-logo-image qodef--light" alt="logo main" loading="lazy" /></a>
    ...
    <header id="qodef-page-mobile-header">
      <div id="qodef-page-mobile-header-inner">
        <a itemprop="url" class="qodef-mobile-header-logo-link" href="../index.html" rel="home">
          <img src="img/logo.png" class="qodef-header-logo-image qodef--main" alt="logo main" />
          <img width="202" height="60" src="../wp-content/uploads/2019/12/header-logo-light.png" class="qodef-header-logo-image qodef--dark" alt="logo dark" loading="lazy" /><img width="202" height="60" src="img/logo.png" class="qodef-header-logo-image qodef--light" alt="logo light" loading="lazy" /></a><a id="qodef-mobile-header-opener" href="#">
