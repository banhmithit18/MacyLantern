...
if($function == "edit_blog")
{
    ...
    $blog->blog_priority = $blog_priority;
    $blog->blog_status = $blog_status;
    $blog->image_id = $result[0]['image_id'];
    $blog->blog_content_path = $result[0]['blog_content_path'];
...
if($function == "delete_blog")
{
    ...
    $db = new DBConnection();
    if ($db -> delete($blog)){
        WriteLog("Delete blog","Delete blog with id = $banner_id");
...
if($function == "update_image")
{
    ...
    $blog->blog_title = $ib[0]['blog_title'];
    $blog->blog_priority = $ib[0]['blog_priority'];
    $blog->blog_status = $ib[0]['blog_status'];
    $blog->blog_content_path = $ib[0]['blog_content_path'];
    $blog->image_id = $image['image_id'];
    //update blog
