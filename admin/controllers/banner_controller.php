...
if ($function == "edit_banner") {
    ...
    $banner->banner_priority = $banner_priority;
    $banner->banner_status = $banner_status;
    $banner->image_id = $result[0]['image_id'];
...
if ($function == "add_banner") {
    ...
    if ($db->Create($banner)) {
        ...
        if ($banner_image != "") {
            ...
            if ($return['status'] == 1) {
                $banner->image_id = $return['image_id'];
...
if ($function == "update_image") {
    ...
    $banner->image_id = $image['image_id'];
    $banner->banner_title = $ib[0]['banner_title'];
    $banner->banner_priority =  $ib[0]['banner_priority'];
    $banner->banner_status = $ib[0]['banner_status'];
    $banner->banner_content = $ib[0]['banner_content'];
    $banner->banner_link = $ib[0]['banner_link'];
    $banner->banner_type = $ib[0]['banner_type'];
    //update banner
