<?php include '../MacyLantern/includes/header.php'; ?>
    ...
    <main id="qodef-page-content" class="qodef-grid qodef-layout--template">
      <div class="qodef-grid-inner clear">
        <div class="qodef-grid-item qodef-page-content-section qodef-col--12">
                    ...
                    <rs-module id="rev_slider_1_1" data-version="6.2.22">
                      <rs-slides>
                        ...
                        <rs-slide data-key="rs-4" data-title="Slide" data-anim="ei:d;eo:d;s:1000;r:0;t:fade;sl:0;">
                          <img src="img/banner/banner_3.jpeg" alt="x" title="h1-slider-img-2" width="1920" height="1100" data-panzoom="d:10000;ss:105%;se:100%;" class="rev-slidebg" data-no-retina />
                          ><rs-layer id="slider-1-slide-4-layer-2" data-type="text" data-xy="x:c;xo:0,7px,0,0;y:m;yo:-47px,-43px,11px,1px;" data-text="w:normal;s:115,95,80,50;l:100,100,85,55;a:center;" data-dim="w:943px,696px,502px,394px;" data-basealign="slide" data-rsp_o="off" data-rsp_bd="off" data-frame_0="y:50;" data-frame_1="st:200;sp:800;" data-frame_999="o:0;st:w;sR:7790;" style="
                                    ...
                                    font-style: italic;
                                  ">Light your soul, guide your heart </rs-layer>
                          <rs-layer id="slider-1-slide-4-layer-2" data-type="text" data-xy="x:c;y:m;yo:154px,146px,157px,136px;" data-text="s:20,15,11,6;l:25,19,14,8;" data-basealign="slide" data-rsp_o="off" data-rsp_bd="off" data-frame_0="y:50;" data-frame_1="st:300;sp:800;" data-frame_999="o:0;st:w;sR:7610;" style="z-index: 13; font-family: Roboto"><a class="qodef-shortcode qodef-m qodef-button qodef-layout--outlined qodef-html--link" href="about-us/index.html" target="_self" data-hover-color="#3e3930" data-hover-background-color="#ffffff" data-hover-border-color="#ffffff" style="
                                      color: #ffffff;
                                      border-color: #ffffff;
                                      padding: 7px 42px;
                                    ">
                        ...
                        <rs-slide data-key="rs-3" data-title="Slide" data-anim="ei:d;eo:d;s:1000;r:0;t:fade;sl:0;">
                          <img src="img/banner/banner_5.jpeg" alt="x" title="h1-slider-img-2" width="1920" height="1100" data-panzoom="d:10000;ss:105%;se:100%;" class="rev-slidebg" data-no-retina />
          ...
          <!-- product -->
          <div class="vc_row wpb_row vc_row-fluid vc_custom_1572862193493 vc_row-o-content-middle vc_row-flex qodef-content-alignment-left">
                    ...
                    <div class="qodef-m-images">
                      <div class="qodef-e-main-image-holder">
                        <div class="qodef-e-main-image-zoom-holder">
                          <img width="1300" height="1123" src="img/banner/product/product.jpg" class="qodef-e-main-image" alt="x" loading="lazy" srcset="
                                    img/banner/product/product.jpg           1300w,
                                    img/banner/product/product-600x518.jpg   600w,
                                    img/banner/product/product-800x691.jpg   800w,
                                    img/banner/product/product-300x259.jpg   300w,
                                    img/banner/product/product-768x663.jpg   768w,
                                    img/banner/product/product-1024x885.jpg 1024w
              ...
              <div class="vc_column-inner vc_custom_1577090295829">
                <div class="wpb_wrapper">
                  <div class="qodef-shortcode qodef-m qodef-section-title qodef-alignment--left">
                    <h4 class="qodef-m-title">Make your event more memorable with our lanterns</h4>
                    <p class="qodef-m-text">
                      Autem dicant cum ex, ei vis nibh solum simul,
                      veritus fierent fastidii quo ea. Cu solum scripta
                      pro. Qui in clita everti propriae, vidit voluptaria
                      cum ne, at nec sint movet delectus sit mazim.
                    </p>
                  </div>
          ...
          <!--blog -->
          <div class="vc_row wpb_row vc_row-fluid vc_custom_1572862520397 vc_row-o-content-middle vc_row-flex qodef-content-alignment-left">
            <div class="wpb_column vc_column_container vc_col-sm-12 vc_col-lg-6 vc_col-md-12">
              <div class="vc_column-inner vc_custom_1576766761946">
                <div class="wpb_wrapper">
                  <div class="qodef-shortcode qodef-m  qodef-section-title qodef-alignment--left ">
                    <h4 class="qodef-m-title">
                      Shine your memorable day on love. </h4>
                    <p class="qodef-m-text">
                      Chalice Hungarian Horntail, catherine wheels Essence of Dittany Gringotts Harry Potter.
                ...
                <div class="wpb_wrapper">
                  <div class="qodef-shortcode qodef-m  qodef-stacked-images qodef-layout--default qodef-stack--bottom">
                    <div class="qodef-m-images">
                      <div class="qodef-e-main-image-holder">
                        <div class="qodef-e-main-image-zoom-holder">
                          <img width="1300" height="1123" src="img/banner/blog/blog.jpg" class="qodef-e-main-image" alt="x" loading="lazy" srcset="
                                    img/banner/blog/blog.jpg           1300w,
                                  " sizes="(max-width: 1300px) 100vw, 1300px" />
                        </div>
                      </div>
                    </div>
          ...
          <div class="vc_row wpb_row vc_row-fluid vc_custom_1572862193493 vc_row-o-content-middle vc_row-flex qodef-content-alignment-left">
                    ...
                    <div class="qodef-m-images">
                      <div class="qodef-e-main-image-holder">
                        <div class="qodef-e-main-image-zoom-holder">
                          ...
                          <img width="1300" height="1123" src="img/banner/about-us/about-us.jpg" class="qodef-e-main-image" alt="x" loading="lazy" srcset="
                                    img/banner/about-us/about-us.jpg           1300w,
                                    img/banner/about-us/about-us-600x518.jpg   600w,
                                    img/banner/about-us/about-us-800x691.jpg   800w,
                                    img/banner/about-us/about-us-300x259.jpg   300w,
                                    img/banner/about-us/about-us-768x663.jpg   768w,
                                    img/banner/about-us/about-us-1024x885.jpg 1024w
                                  " sizes="(max-width: 1300px) 100vw, 1300px" />
                        </div>
                      </div>
                    </div>
            ...
            <div class="wpb_column vc_column_container vc_col-sm-12 vc_col-lg-6 vc_col-md-12">
              <div class="vc_column-inner vc_custom_1577090295829">
                <div class="wpb_wrapper">
                  <div class="qodef-shortcode qodef-m qodef-section-title qodef-alignment--left">
                    <h4 class="qodef-m-title">The spirit of delight on your remarkable day</h4>
                    <p class="qodef-m-text">
            ...
            <div class="wpb_column vc_column_container vc_col-sm-12 vc_col-lg-6 vc_col-md-12">
              <div class="vc_column-inner vc_custom_1576766761946">
                <div class="wpb_wrapper">
                  <div class="qodef-shortcode qodef-m  qodef-section-title qodef-alignment--left ">
                    <h4 class="qodef-m-title">
                      We deliver the spirit of delight to your unforgettable day </h4>
                    <p class="qodef-m-text">
                      Boggarts lavender robes, Hermione Granger Fantastic Beasts and Where to Find Them.
                      Bee in your bonnet Hand of Glory elder wand, spectacles House Cup Bertie Bott’s
                      Every Flavor Beans Impedimenta. Stunning spells tap-dancing spider Slytherin’s
                      Heir mewing kittens Remus Lupin. Palominos scarlet train black robes, Metamorphimagus
                ...
                <div class="wpb_wrapper">
                  <div class="qodef-shortcode qodef-m  qodef-stacked-images qodef-layout--default qodef-stack--bottom">
                    <div class="qodef-m-images">
                      <div class="qodef-e-main-image-holder">
                        <div class="qodef-e-main-image-zoom-holder">
                          <img width="1300" height="1123" src="img/banner/contact-us/contact-us.jpg" class="qodef-e-main-image" alt="x" loading="lazy" srcset="
                                    img/banner/contact-us/contact-us.jpg           1300w,
                                  " sizes="(max-width: 1300px) 100vw, 1300px" />
                        </div>
                      </div>
                    </div>
...
<?php include '../MacyLantern/includes/footer.php'; ?>